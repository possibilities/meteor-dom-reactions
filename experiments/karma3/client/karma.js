if (Meteor.is_client) {
  ...
  Template.user_1_karma.user_1_karma = function() {
    return Session.get('user_1_karma');
  };
  Template.user_2_karma.user_2_karma = function() {
    return Session.get('user_2_karma');
  };

  Template.user_1_and_2_karma.user_1_karma = function() {
    return Session.get('user_1_karma');
  };
  Template.user_1_and_2_karma.user_2_karma = function() {
    return Session.get('user_2_karma');
  };
